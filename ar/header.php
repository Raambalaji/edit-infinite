...
<style>
    ...
    .classic-language-bar .dropdown-menu ol {list-style-type: none;padding-left: 0px;padding-right: 0px;margin-bottom: 0px;}
    ...
    @media (max-width: 1023px) {
        .navbar-toggler {position: absolute;left: 18vw;top:0;}
    ...
    @media (max-width: 350px) {
        .navbar-toggler {position: absolute;left: 22vw;top:0;}
    }
        ...
        <div class="container-fluid justify-content-between navpadding">
            ...
            <div class="classic-language-bar d-block d-sm-block d-lg-none">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <ol>
                            <li class="text-end">
                                <a href="/ar" class="justify-content-start active"><img src="../assets/img/united-arab-emirates.png" class="img-fluid" style="width:24px;">&nbsp;&nbsp;&nbsp;&nbsp;العربية</a>
                            </li>
                            <li class="text-end">
            ...
            <div class="collapse navbar-collapse justify-content-end w-75" id="navbarNavAltMarkup">
                <div class="navbar-nav justify-content-end w-100 text-center">
                    <a class="nav-link" href="solutions.php">حلولنا</a>
                    <a class="nav-link" href="about.php">عنا</a>
                    <a class="nav-link" href="pricing.php">التسعير</a>
                    <a class="nav-link" href="blog.php">المدونة</a>
                    <a class="nav-link" href="blognewsline.php">في الأخبار</a>
                    ...
                    <li class="classic-language-bar d-block d-lg-block d-none">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <ol>
                                    <li class="text-end">
                                        <a href="ar/" class="justify-content-start active"><img src="../assets/images/united-arab-emirates.png" class="img-fluid" style="width:24px;">&nbsp;&nbsp;&nbsp;&nbsp;العربية</a>
                                    </li>
                                    <li class="text-end">
                                        <a href="../index.php" class="justify-content-start">
                                            <span><img src="../assets/images/united-states-of-america.png" class="img-fluid" style="width:24px;">&nbsp;&nbsp;&nbsp;&nbsp;ENGLISH</span>
                                        </a>
                                    </li>
                                </ol>
                            </div>
