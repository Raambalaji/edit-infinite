          ...
          <div class="row footerborder">
            <div class="col-lg-5 col-md-6">
              <div class="">
                ...
                <div class="footermargin">
                  <a href="editinfiniteprivacypolicy.php"> Edit-Infinite Privacy Policy  |</a> 
                  <a href="dataprotectionprivacypolicy.php"> Data Protection Policy  |</a>
                  <a href="cookiesprivacypolicy.php"> Cookies Policy</a> <br> 
                  Copyright <strong><span> &copy; 2023 Edit Infinite</span></strong>. All Rights Reserved
                </div>              
              </div>
            </div>
            ...
            <div class="col-lg-2 col-md-6 footer-links">
              ...
              <ul>
                ...
                <li><i class="bx bx-chevron-right"></i> <a href="solutions.php">Our Solutions</a></li>
            ...
            <div class="col-lg-2 col-md-6 footer-links">
              <h4>OUR SERVICES</h4>
              <ul>
                <li><i class="bx bx-chevron-right"></i> <a href="solutions.php#editing">Image Editing</a></li>
                <li><i class="bx bx-chevron-right"></i> <a href="solutions.php#Clipping">Image Clipping</a></li>
                <li><i class="bx bx-chevron-right"></i> <a href="solutions.php#Retouching">Image Retouching</a></li>
                <li><i class="bx bx-chevron-right"></i> <a href="solutions.php#Manipulation">Image Manipulation</a></li>
              </ul>
            </div>
            ...
            <div class="col-lg-3 col-md-6 footer-newsletter">
              <h4>CONTACT</h4>
              <p class="bodyfonts"> 
                <strong>Call Us:</strong><a href="tel:971563699788" class="text-black"> +971 56 369 9788</a><br><br>
                <strong>Email Us:</strong> <a href="mailto:info@editinfinite.com" class="text-black">info@editinfinite.com</a><br><br>
                </p>
            </div>
          </div>
        </div>
